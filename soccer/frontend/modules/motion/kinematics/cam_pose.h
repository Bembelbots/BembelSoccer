...
private:
    ...
    Eigen::Matrix4f getHeadTransformation(joints::Sensors &s, const Eigen::Vector3f &a, float balancingFoot);
...
public:
    std::array<camPose,2> getPose(joints::Sensors &sensors, Eigen::Vector3f bodyAngles);
};    
