...
class VisionResult():    
    def __init__(self, data = None):
        self.types = ["nothing", "field", "ball", "rect", "goal",
                      "line", "lcrossing","tcrossing","xcrossing",
                      "penalty", "circle", "face", "scanpoint", "robot"]

        self.initValues()
        if data is None:
            return

        unpackData = struct.unpack_from("8i8f2if", data)
